...
func NewErrorGuildGVGFightBuildHurt() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_fight_build_hurt"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGSignupFailed() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_signup_failed"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGSignupFailedFunction() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_signup_failed_function"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGInFighting() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_in_fighting"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGSignupFailedActive() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_signup_failed_active"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGInMatch() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_in_match"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGNotCanMask() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_not_can_mask"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGSignupFailedMember() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_signup_failed_member"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGAlreadySignup() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_already_signup"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGCanNotMaskSelf() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_can_not_mask_self"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGFightInFight() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_fight_in_fight"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGNoAttackCount() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_no_attack_count"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGNotJoin() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_not_join"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGInSignup() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_in_signup"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGNotSignup() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_not_signup"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGSignupNoAccess() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_signup_no_access"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGNotFoundBuild() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_not_found_build"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGNotCanFightBuild() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_not_can_fight_build"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGFightInvalid() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_fight_invalid"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGCanNotFightSelfGuild() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_can_not_fight_self_guild"
	if openStack {
		e.WithStack()
	}
	return e
...
func NewErrorGuildGVGFightDead() *ErrMsg {
	e := &ErrMsg{}
	e.ErrCode = 1
	e.ErrMsg = "error_guild_gvg_fight_dead"
	if openStack {
		e.WithStack()
	}
	return e
