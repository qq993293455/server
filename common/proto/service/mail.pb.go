...
type Mail_SendMailFromOtherServer struct {
	Mail *models.Mail `protobuf:"bytes,1,opt,name=mail,proto3" json:"mail,omitempty"`
}

func (m *Mail_SendMailFromOtherServer) Reset()      { *m = Mail_SendMailFromOtherServer{} }
func (*Mail_SendMailFromOtherServer) ProtoMessage() {}
func (*Mail_SendMailFromOtherServer) Descriptor() ([]byte, []int) {
	return fileDescriptor_9569a1a678496cf8, []int{0, 6}
}
func (m *Mail_SendMailFromOtherServer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Mail_SendMailFromOtherServer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Mail_SendMailFromOtherServer.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Mail_SendMailFromOtherServer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Mail_SendMailFromOtherServer.Merge(m, src)
}
func (m *Mail_SendMailFromOtherServer) XXX_Size() int {
	return m.Size()
}
func (m *Mail_SendMailFromOtherServer) XXX_DiscardUnknown() {
	xxx_messageInfo_Mail_SendMailFromOtherServer.DiscardUnknown(m)
}

var xxx_messageInfo_Mail_SendMailFromOtherServer proto.InternalMessageInfo

func (m *Mail_SendMailFromOtherServer) GetMail() *models.Mail {
	if m != nil {
		return m.Mail
	}
	return nil
...
func (*Mail_SendMailFromOtherServer) XXX_MessageName() string {
	return "service.Mail.SendMailFromOtherServer"
}
...
func (*Mail_CheatAddMailResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9569a1a678496cf8, []int{0, 12}
}
...
func init() {
	...
	proto.RegisterType((*Mail_SendMailFromOtherServer)(nil), "service.Mail.SendMailFromOtherServer")
...
var fileDescriptor_9569a1a678496cf8 = []byte{
	...
	,
}
...
func init() {
	...
	coin_server_common_msgcreate.RegisterNewMessage(func() proto.Message {
		return poolMail_SendMailFromOtherServer.Get().(proto.Message)
	})
	coin_server_common_msgcreate.RegisterNewMessage(func() proto.Message {
...
var poolMail_SendMailFromOtherServer = &sync.Pool{New: func() interface{} { return &Mail_SendMailFromOtherServer{} }}

func (m *Mail_SendMailFromOtherServer) ReleasePool() {
	m.Reset()
	poolMail_SendMailFromOtherServer.Put(m)
	m = nil
}
...
func (this *Mail_SendMailFromOtherServer) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Mail_SendMailFromOtherServer)
	if !ok {
		that2, ok := that.(Mail_SendMailFromOtherServer)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *Mail_SendMailFromOtherServer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Mail_SendMailFromOtherServer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Mail_SendMailFromOtherServer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Mail_SendMailFromOtherServer) JsonBytes(w *coin_server_common_jwriter.Writer) {
	if m == nil {
		w.RawString("null")
		return
	}
...
func (m *Mail_SendMailFromOtherServer) MarshalJSON() ([]byte, error) {
	w := coin_server_common_jwriter.Writer{Buffer: coin_server_common_buffer.Buffer{Buf: make([]byte, 0, 2048)}}
	m.JsonBytes(&w)
	return w.BuildBytes()
}
func (m *Mail_SendMailFromOtherServer) String() string {
	d, _ := m.MarshalJSON()
	return *(*string)(unsafe.Pointer(&d))
}
func (m *Mail_SendMailFromOtherServer) GoString() string {
	return m.String()
}
...
func (m *Mail_SendMailFromOtherServer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Mail_SendMailFromOtherServer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SendMailFromOtherServer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SendMailFromOtherServer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
