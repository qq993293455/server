...
type Battle struct {
	...
	Mission  int64          `json:"mission" gorm:"column:mission;type:int(11);not null" desc:"关卡"`
	EventTyp BattleEventTyp `json:"event_typ" gorm:"column:event_typ;type:int(11);not null" desc:"事件类型"`
}

func (i *Battle) TableName() string {
	t := i.Time.UTC().Format("20060102")
	return i.Topic() + "_" + t
}

func (i *Battle) GetRoleId() []byte {
	return utils.StringToBytes(i.RoleId)
}

func (i *Battle) Topic() string {
	return BattleTopic
}

func (i *Battle) ToJson() ([]byte, error) {
	return json.Marshal(i)
}

func (i *Battle) ToArgs() []interface{} {
...
func (i *Battle) NewModel() Model {
	return &Battle{}
}

func (i *Battle) Desc() string {
	return "战斗"
}
