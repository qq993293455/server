...
type Logout struct {
	...
	OnlineSeconds int64         `json:"online_seconds" gorm:"column:online_seconds;type:int(11);not null" desc:"单次在线时间"`
...
func (l *Logout) TableName() string {
	t := l.Time.UTC().Format("20060102")
	return l.Topic() + "_" + t
}

func (l *Logout) GetRoleId() []byte {
	return utils.StringToBytes(l.RoleId)
}

func (l *Logout) Topic() string {
	return LogoutTopic
}

func (l *Logout) ToJson() ([]byte, error) {
	return json.Marshal(l)
}

func (l *Logout) ToArgs() []interface{} {
...
func (l *Logout) NewModel() Model {
	return &Logout{}
}

func (l *Logout) Desc() string {
	return "登出"
}
