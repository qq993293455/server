...
func (i *GotItem) TableName() string {
	t := i.Time.UTC().Format("20060102")
	return i.Topic() + "_" + t
}

func (i *GotItem) GetRoleId() []byte {
	return utils.StringToBytes(i.RoleId)
}

func (i *GotItem) Topic() string {
	return GotItemTopic
}

func (i *GotItem) ToJson() ([]byte, error) {
	return json.Marshal(i)
}

func (i *GotItem) ToArgs() []interface{} {
...
func (i *GotItem) NewModel() Model {
	return &GotItem{}
}

func (i *GotItem) Desc() string {
	return "道具消耗"
}
